...
class Respath(torch.nn.Module):
	...
	def __init__(self, num_filters, respath_length):
		...
		for i in range(self.respath_length):
			if(i==0):
				self.shortcuts.append(Conv2d_batchnorm(num_filters, num_filters, kernel_size = (1,1), activation='None'))
				self.convs.append(Conv2d_batchnorm(num_filters, num_filters, kernel_size = (3,3),activation='relu'))
			...
			self.bns.append(torch.nn.BatchNorm2d(num_filters))
